...
tradeable_capital_usdt = 500000 # total tradeable capital to be split between both pairs
...
# TEST API
api_key_testnet = "4Ntv4LsHlrIT9iMZq9"
api_secret_testnet = "uSjgs6HItOvueAhAnKPGtJ5PGbinoNkvCnBZ"
